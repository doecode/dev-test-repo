...
| accessibility | This refers to how the source of the project type is accessed; must be one of “OS” (open source), “ON” (open source, not public) or “CS” (closed source) |
